...
em++ -g -O2 -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s TOTAL_MEMORY=33554432 -o xetex $XETEX_OBJECTS $XETEX_DEPS $TEXLIVE_BUILD_DIR/libs/icu/icu-build/lib/libicudata.a
#$TEXLIVE_BUILD_DIR/libs/icu/icu-build/stubdata/libicudata.a
